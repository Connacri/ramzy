...
class homeList_StateFull extends StatefulWidget {
  homeList_StateFull({
    Key? key,
  ...
  @override
  State<homeList_StateFull> createState() => _homeList_StateFullState();
}

class _homeList_StateFullState extends State<homeList_StateFull>
...
// Assuming you have a reference to your Firestore instance
  ...
  String get foodWall =>
      'https://img.freepik.com/premium-photo/man-scooter-with-boxes-front-it_605423-7862.jpg';
  ...
  void _createBannerAd() {
    _ad = BannerAd(
      size: AdSize.banner,
      adUnitId:
          AdMobService.bannerAdUnitId!, // Replace with your actual Ad Unit ID
  ...
  //     adUnitId:
  //         AdMobService.bannerAdUnitId!, // Replace with your actual Ad Unit ID
  //     listener: AdMobService
  //         .bannerListener, // Make sure bannerListener is defined in AdMobService
  ...
  Widget build(BuildContext context) {
    ...
    var itm = iitem.documents
        ...
        .toList();
    var BestLikesitm = iitem.documents.toList();
    // var BestLikes = BestLikesitm.sort((a, b) => b['likes'].compareTo(a['likes']));
            ...
            children: [
                ...
                child: Center(
                  child: GestureDetector(
                    onTap: () => Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => HomeScreen_food(
                              userDoc: userDoc,
                            ))),
                    child: Card(
                                ...
                                child: Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      //     MaterialPageRoute(
                                      //         builder: (context) => SpinningContainer())),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  physics: BouncingScrollPhysics(),
                  scrollDirection: Axis.horizontal,
                  itemCount: BestLikesitm.length,
                  //1, //(iitem.documents.length / 3).truncate(),
                  itemBuilder: (BuildContext context, int index) {
                    BestLikesitm.sort(
                        (a, b) => b['likes'].compareTo(a['likes']));
                    var data = BestLikesitm[index].data() as Map;

                    return GestureDetector(
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => SilverdetailItem(
                          data: data,
                          idDoc: BestLikesitm[index].id,
                          isLiked:
                              data['usersLike'].toString().contains(user!.uid),
                        ),
                      )),
                      child: Card(
                        ...
                        child: Column(
                          children: [
                              ...
                              children: [
                                ShaderMask(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    width: 100,
                                    height: 130,
                                    imageUrl: BestLikesitm[index]['themb'],
                                    //iitem.documents[index]['themb'],
                                    // 'https://firebasestorage.googleapis.com/v0/b/adventure-eb4ca.appspot.com/o/carre%2Fcarre%20(${index + 1}).jpg?alt=media&token=68e384f1-bb64-47cf-a245-9f7f12202443',
                                    errorWidget: (context, url, error) =>
                                        const Icon(
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding:
                                    const EdgeInsets.symmetric(horizontal: 4.0),
                                child: Text(
                                  BestLikesitm[index]['item']
                                      .toString()
                                      .toUpperCase(),
                                  overflow: TextOverflow.ellipsis,
                                  textAlign:
                                      isArabic(BestLikesitm[index]['item'])
                                          ? TextAlign.right
                                          : TextAlign.left,
                                  style: isArabic(BestLikesitm[index]['item'])
                                      ? GoogleFonts.cairo(
                                          // textStyle: Theme.of(context).textTheme.headline4,
                                          fontSize: 12,
                                        )
                            ...
                            Container(
                              width: 100,
                              child: BestLikesitm[index]['price'] <= 0
                                  ? Text('')
                                  : Padding(
                                      padding: const EdgeInsets.symmetric(
                                          horizontal: 4.0),
                                      child: BestLikesitm[index]['price'] >=
                                              1000
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding:
                                    const EdgeInsets.symmetric(horizontal: 4.0),
                                child: Text(
                                  '${BestLikesitm[index]['category']}-${BestLikesitm[index]['levelItem']}',
                                  //   '${iitem.documents[index]['category']}  ${iitem.documents[index]['levelItem']}',
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(fontSize: 12),
                                ),
